    ...
    return (
        <div className='relative lg:mt-[200px] md:mt-[175px] mt-[130px] xs:mt-[100px]'>
            ...
            <div className='flex items-center justify-center flex-col'>
                ...
                <h1 className='text-header_primary-0 font-Volkhov font-medium md:text-5xl text-4xl xs:text-3xl xxs:text-2xl mt-2'>We Offer Best Services</h1>
                <div className='grid md:grid-cols-4 grid-cols-2 gap-y-6 md:gap-0 sm-max:gap-x-10 xxs:gap-x-5 mt-[90px] xs:mt-[70px] xxs:mt-[35px]'>
                    <div className='flex items-center justify-center flex-col xl:px-11 px-5 xxs:px-3 md:w-auto sm:w-[250px] sm-max:w-[220px] xs:w-[185px] xxs:w-[145px] xl:py-10 py-4'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-[30px]'>
                            <h1 className='font-[600] font-Open_Sans text-header_primary-0 lg:text-[1.15rem] text-[0.9rem] text-center'>Calculated Weather</h1>
                    ...
                    <div className='relative flex items-center justify-center flex-col xl:px-11 px-5 xxs:px-3 md:w-auto sm:w-[250px] sm-max:w-[220px] xs:w-[185px] xxs:w-[145px] xl:py-10 :py-4 rounded-[36px] bg-white custom_shadow'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-[31px]'>
                            <h1 className='font-[600] font-Open_Sans text-header_primary-0 lg:text-[1.15rem] text-[0.9rem] text-center'>Best Flights</h1>
                    ...
                    <div className='bg-white md:bg-transparent relative flex items-center justify-center flex-col xl:px-11 px-5 xxs:px-3 md:w-auto sm:w-[250px] sm-max:w-[220px] xs:w-[185px] xxs:w-[145px] xl:py-10 py-4 rounded-[36px] sm:rounded-0 md:shadow-0 md:shadow-white
                    shadow-[0px_100px_80px_rgba(0,0,0,0.02),0px_64.8148px_46.8519px_rgba(0,0,0,0.0151852),0px_38.5185px_25.4815px_rgba(0,0,0,0.0121481),0px_20px_13px_rgba(0,0,0,0.01),0px_8.14815px_6.51852px_rgba(0,0,0,0.00785185),0px_1.85185px_3.14815px_rgba(0,0,0,0.00481481)]'>
                        <div className='relative'>
                            <img src={MicroPhone} alt="" className='xl:w-[35px] w-[33px] relative z-10' />
                            <span className='rounded-[18px_5px_10px] absolute -top-1 -right-6 bg-[#FFF1DA] w-[50px] h-[50px]' style={{ transform: "matrix(-1, 0, 0, 1, 0, 0)" }}></span>
                        </div>
                        <div className='flex flex-col items-center justify-center mt-[30px]'>
                            <h1 className='font-[600] font-Open_Sans text-header_primary-0 lg:text-[1.15rem] text-[0.9rem] text-center'>Local Events</h1>
                        ...
                        <span className='bg-[#DF6951] md:hidden xl:w-[100px] md:w-[75px] w-[55px] xl:h-[100px] md:h-[75px] h-[55px] absolute xl:-bottom-[35px] md:-bottom-[20px] -bottom-[18px] xl:-right-[40px] md:-right-[25px] -right-[18px] -z-10 md:rounded-[0px_30px_0px_10px] rounded-[0px_20px_0px_5px]'></span>
                    </div>
                    <div className='flex items-center justify-center flex-col xl:px-11 px-5 xxs:px-3 md:w-auto sm:w-[250px] sm-max:w-[220px] xs:w-[185px] xxs:w-[145px] xl:py-10 py-4'>
                        <div className='relative'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-[30px]'>
                            <h1 className='font-[600] font-Open_Sans text-header_primary-0 lg:text-[1.15rem] text-[0.9rem] text-center'>Customization</h1>
